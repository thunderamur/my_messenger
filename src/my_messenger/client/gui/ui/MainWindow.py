...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButtonSmile = QtWidgets.QPushButton(self.groupBoxChatName)
        self.pushButtonSmile.setGeometry(QtCore.QRect(100, 280, 21, 21))
        self.pushButtonSmile.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../img/smile/ab.gif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButtonSmile.setIcon(icon3)
        self.pushButtonSmile.setIconSize(QtCore.QSize(20, 24))
        self.pushButtonSmile.setObjectName("pushButtonSmile")
        self.labelSmileBtn = QtWidgets.QLabel(self.groupBoxChatName)
        self.labelSmileBtn.setGeometry(QtCore.QRect(130, 280, 21, 21))
